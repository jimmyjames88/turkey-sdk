...
export class TurKeyClient {
  ...
  async requestPasswordReset(
    ...
    const response = await this.request<{ data: RequestPasswordResetResponse }>(
  ...
  async resetPassword(
    ...
    const response = await this.request<{ data: ResetPasswordResponse }>(
  ...
  async verifyEmail(token: string): Promise<VerifyEmailResponse> {
    const response = await this.request<{ data: VerifyEmailResponse }>(
  ...
  async resendVerification(email: string): Promise<ResendVerificationResponse> {
    const response = await this.request<{ data: ResendVerificationResponse }>(
